...
<head>
    ...
    <link href="<?php bloginfo('stylesheet_directory'); ?>/css/common.min.css" rel="stylesheet" />
    <link id="jquery-ui-css" rel="stylesheet" href="//code.jquery.com/ui/1.11.1/themes/start/jquery-ui.css" />
    <link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo('stylesheet_url'); ?>" />
    <link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/css/wp-default.min.css" />
